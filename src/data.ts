...
/** @type {QuestDef[]} */
const QUESTS=[
 {id:'n1',name:'はじまりの草原',icon:'🌿',cost:4,rank:1,enemy:'森牙ウルフ',enemyIcon:'🐺',element:'木',tribe:'獣',hp:430,atk:20,xp:24,gold:80,drops:[['slime',.28],['rabit',.22]]},
 {id:'n2',name:'灼熱の火山道',icon:'🌋',cost:7,rank:2,enemy:'火鱗ワイバーン',enemyIcon:'🐲',element:'火',tribe:'ドラゴン',hp:780,atk:32,xp:48,gold:160,drops:[['salam',.25],['ember',.22]]},
 {id:'n3',name:'轟岩洞',icon:'🪨',cost:9,rank:3,enemy:'岩殻虫ロード',enemyIcon:'🪲',element:'木',tribe:'甲虫',hp:1080,atk:40,xp:70,gold:240,drops:[['shell',.3]]},
...
const fresh=()=>({version:5,starter:null,rank:1,exp:0,gems:620,gold:1600,crystals:2,stamina:30,maxStamina:30,staminaAt:Date.now(),owned:{},party:[],page:'home',cleared:[],adventCleared:[],battle:null});
